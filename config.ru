...
<p>After pushing changes, you'll need to manually trigger a build if you did not setup a webhook as described above. Well i have no idea how to set a webhook</p>
      </section>
          </section>
          <section class="col-xs-12 col-sm-6 col-md-6">
